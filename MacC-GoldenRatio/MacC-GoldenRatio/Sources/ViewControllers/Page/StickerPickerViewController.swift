...
class StickerPickerViewController: UIViewController {
    ...
    private let stickerArray: [String] = ["manLong", "manLong2", "womanLong", "womanLong2", "manShort", "womanShort", "neckPillow", "passport", "passport2", "broom", "ghost1", "ghost2", "ghost3", "ghost4", "ghost5", "ghost6", "ghost7", "pot", "pumpkin1", "pumpkin2", "pumpkin3", "wizardHat"]
